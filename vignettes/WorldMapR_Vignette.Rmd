...
By default, the EPGS::4326 (WGS84) reference system is used. This is a nice system if you want to plot the whole world; however, if you are interested in selected regions, other reference systems may be preferable.

For example, for the EPGS::3035 is a nice projection for focusing on Europe.
...
Notably, the function automatically updates the coordinates of the labels when a different crs is defined, meaning that these values might help to find the coordinates you want to show (NEED TO WORK ON THIS).
