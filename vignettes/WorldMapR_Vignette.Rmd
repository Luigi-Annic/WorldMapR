...
The transform_limits argument is still under development; you can still set that to FALSE and manually set the extreme values for the coordinates. Some trial and error might still be needed to find the best position.

In a future release, ESRI projections will be available.
